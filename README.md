...
Reach the green goal block in each stage while avoiding spikes and patrolling enemies, collecting as many gems as you can along the way. There are 10 levels to clear, plus jump-boost pads to help with bigger gaps. Level 10 features a boss with unique abilities and accompanying boss-battle music if a file named like `*boss*.ogg|.mp3|.wav` is present alongside the game.
