...
- After the boss is defeated, its eye blacks out and it rockets off-screen before a fiery celebration: the backdrop and ground ignite, the player auto-dances to `What we Do Here is Go Back - Otis McDonald.mp3` (auto-detected) for a minute, then the music stops, the dance ends, and an encore wave of ground gunners spawns. Clear them and the hero will auto-walk right toward the exit where the “Level 11 / Chapter 2 coming soon” teaser awaits.
